...
public class SampleTest {
	...
	Long acmeCorp;
	/**
	 * The account number for TinselTown
	 */
	Long tinselTown;
	...
	public void setUp() throws Exception {
		...
		Company company2TinselTown = new Company("TinselTown", 2);
		...
		tinselTown = bank.openCommercialAccount(company2TinselTown, 2222, 9876543.21);
	}
	...
	public void invalidAccountNumberTest() {
		...
		assertEquals(bank.getBalance(tinselTown), 9876543.21, 0);
		Assert.assertNotEquals(bank.getBalance(ameliaPond), bank.getBalance(roseTyler));
		Assert.assertNotEquals(bank.getBalance(acmeCorp), bank.getBalance(tinselTown));
	}
	...
	public void debitTest() {
		...
		assertTrue("Account " + tinselTown + " should have sufficient funds.", bank.debit(tinselTown, amount));
	}
	...
	public void bankCreditTest() {
		...
		assertEquals(beforeDeposit4 + amount, bank.getBalance(tinselTown), 0);
	}
